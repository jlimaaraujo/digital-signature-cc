...
@XmlRootElement(name = "GetCertificateWithPin")
public class GetCertificateWithPin {
    ...
    @XmlElementRef(name = "userId", namespace = "http://Ama.Authentication.Service/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> userId;
    @XmlElementRef(name = "pin", namespace = "http://Ama.Authentication.Service/", type = JAXBElement.class, required = false)
